...
import { Title, Stack, Paper, Group, Text, Badge, Button, ActionIcon, Tooltip } from '@mantine/core'
import { IconPlayerPlay, IconPlayerStop, IconTrash, IconTerminal2, IconSettings } from '@tabler/icons-react'
      ...
      <Paper p="lg" radius="md" withBorder style={{ borderColor: 'var(--mantine-color-dark-5)' }}>
        <Stack gap="sm">
          ...
          <Group justify="space-between">
            ...
            <Text size="sm">{server.modLoader || 'Vanilla'}</Text>
          </Group>
          <Group justify="space-between">
